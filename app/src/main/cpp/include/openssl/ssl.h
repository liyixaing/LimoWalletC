 ...
 * implementations cannot handle it at all, which is why we std.include it in
...
/* Don't std.include root CA in chain */
...
# ifdef OSSL_ASYNC_FD
/*
 * Windows application developer has to std.include windows.h to use these.
 */
