 ...
 * 获取读写权限后弹出框
 */
public class RefusePoup extends PopupWindow {
    View view;
    Context context;
    private TextView tv_yes, tv_no;

    public RefusePoup(Context context, View.OnClickListener onClickListener) {
        this.context = context;
        this.view = LayoutInflater.from(context).inflate(R.layout.popup_refuse, null);
